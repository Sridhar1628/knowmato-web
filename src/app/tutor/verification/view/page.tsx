...
export default function VerificationViewPage() {
  ...
  const accountNumber = verification.account_number || "";
  const aadhaarNumber = verification.aadhaar_number || "";

  const infoItems = [
    {
      title: t("bankVerification.holderName"),
      value: verification.account_holder_name || "-",
    },
    {
      title: t("bankVerification.accountNumber"),
      value:
    ...
    {
      title: t("bankVerification.ifsc"),
      value: verification.ifsc_code || "-",
    },
    {
      title: t("bankVerification.bankName"),
      value: verification.bank_name || "-",
    },
    {
      title: t("bankVerification.branch"),
      value: verification.branch_name || "-",
    },
    {
      title: t("bankVerification.accountType"),
      value: verification.account_type || "-",
    },
    {
      title: t("bankVerification.pan"),
      value: verification.pan_number || "-",
    },
    {
      title: t("bankVerification.aadhaar"),
      value:
    ...
    {
      title: t("bankVerification.mobile"),
      value: verification.mobile_number || "-",
    },
    {
      title: t("bankVerification.status"),
        ...
        {verification.rejection_reason && (
          ...
          >
            <p className="font-semibold text-rose-300">
              {t("bankVerification.rejectionReason")}
            </p>
