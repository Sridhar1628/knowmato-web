...
export default function CompanyRecruiterPolicyPage() {
  ...
  // Fetch the sections as an array of objects from translations
  // i18next may return a SpecialObject type; coerce to the expected array shape
  const sections = t("companyPolicy.sections", { returnObjects: true }) as unknown as Array<{
    title: string;
    content: string;
  }>;
