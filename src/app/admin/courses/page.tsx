...
export default function CoursesPage() { 
  ...
  const fetchCourses = async () => { 
    try { 
      ...
      console.error(err); 
      AlertService.error("Load Failed", "Failed to load courses"); 
    } finally { 
      setLoading(false); 
    } 
  }; 
  ...
  const handleDelete = async () => { 
    ...
    try { 
      ...
      AlertService.success("Course Deleted", "Course deleted successfully"); 
      fetchCourses(); 
    } catch (err) { 
      AlertService.error("Delete Failed", "Failed to delete course"); 
    } finally { 
      setDeleting(false); 
