...
export async function generateMetadata({
  ...
  if (!course) {
    return {
      title: "Course Not Found | KnowMato",
      description:
...
export default async function PublicCoursePage({
  ...
  /*
   * Structured data for the public course page.
   *
   * No monetary price is exposed here because KnowMato
   * uses its own credit-based course system.
   */
    ...
    course.total_reviews > 0
      ? {
          aggregateRating: {
            ...
            ratingValue: Number(course.average_rating),
                ...
                <aside className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-2xl backdrop-blur-xl">
                  ...
                  <div className="p-6">
                    ...
                    <p className="mt-2 text-sm leading-6 text-white/50">
                      Register with KnowMato to view more course
                      details and continue your learning journey.
                    </p>
                  ...
                  <section className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl backdrop-blur-xl sm:p-8">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs text-white/40">
                          Learners who can benefit from this course
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="relative z-10 flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-sm leading-7 text-white/50">
                          This course provides a certificate of
                          completion for eligible learners.
                        </p>
                      </div>
                    </div>
                  </section>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 text-center shadow-2xl backdrop-blur-xl sm:p-12">
              ...
              <div className="relative z-10">
                ...
                <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-white/50">
                  Register with KnowMato to view more details about
                  this course and continue your learning journey.
                </p>
