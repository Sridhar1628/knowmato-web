...
export default function StudentGuidelinesPage() {
  ...
  // Fetch the sections array from translations – each section has title and content
  interface StudentGuidelineSection {
    title: string;
    content: string;
  }

  const sections = t("studentGuidelines.sections", {
    returnObjects: true,
  }) as StudentGuidelineSection[];
