    ...
    AlertService.confirm(
      ...
      async () => {
        try {
          await clearTokens();
          dispatch(logout());
          AlertService.success("Success", t("common.logoutSuccess"));
          router.push("/entry");
        } catch (error) {
          console.error("Logout error:", error);
          AlertService.error("Error", t("common.error"));
        }
        onClose();
      },
      "Yes",
      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-white/10 px-4">
          <div className="flex items-center gap-2 overflow-hidden">
            ...
            {effectiveCollapsed && <span className="text-xl">✨</span>}
          </div>
          ...
          <div className="border-t border-white/10 p-4">
            <div className="rounded-xl bg-gradient-to-br from-violet-500/20 to-fuchsia-500/20 p-4 text-center border border-white/10 backdrop-blur-md">
              ...
              <h4 className="font-semibold text-white">
                {t("knowmatoPlus.enableKnowmatoPlus")}
              </h4>
